 ...
 <div>
    ...
    <div className='flex flex-row w-full items-start justify-between'>
      <div className='flex flex-col justify-start mt-[100px]'>
        <h1 className="font-montserrat font-bold text-[64px] leading-[75px]"> <span className='text-red'> Visual </span> <br /> <span className='text-gradient'> Intelligence </span> </h1>
