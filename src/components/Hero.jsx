...
import { diagram, newoil  } from '../assets';
  ...
  <section>
    <div>
      <div className='flex flex-row max-sm:flex-col w-full items-start justify-between'>
        <div className='flex flex-col justify-start ml-[90px] mt-[150px] bg-secondary p-6 rounded-l-2xl z-[0] max-sm:ml-0 max-sm:mt-2'>
        ...
        <div className='flex justify-end mt-[80px] z-0'>
          <img src={newoil} alt="diagram" className="w-[820px] h-[610px] object-contain shadow-xl rounded-3xl z-[0]"  />
        </div>
    </div>
      < Facts />   
    </div>
