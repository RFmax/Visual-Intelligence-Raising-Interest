...
const Examples = () => {
  ...
  <div className='flex flex-col items-center'>
    <h1 className='font-montserrat font-semibold text-[32px] text-gradient py-6'> Visualizing your day </h1>
    <div className='flex flex-col max-w-[1400px] h-[800px] w-full relative group'>
    ...
    <div className='flex top-4 justify-center py-2'>
      {dayVisual.map((visual, visualIndex) => (
        <div key={visualIndex} onClick={() => goToVisual(visualIndex)} className='text-2xl cursor-pointer'><RxDotFilled color='red' /></div>
      ))}
    </div>
